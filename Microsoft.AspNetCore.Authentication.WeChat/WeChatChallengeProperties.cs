...
{
    public class WeChatChallengeProperties : OAuthChallengeProperties
    {
        /// <summary>
        ...
        public WeChatChallengeProperties()
        { }

        public WeChatChallengeProperties(IDictionary<string, string> items)
            : base(items)
        { }

        public WeChatChallengeProperties(IDictionary<string, string> items, IDictionary<string, object> parameters)
