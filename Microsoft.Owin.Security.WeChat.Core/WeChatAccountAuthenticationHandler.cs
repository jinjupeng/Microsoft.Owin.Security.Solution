...
namespace Microsoft.Owin.Security.WeChat.Core
{
    internal class WeChatAccountAuthenticationHandler : AuthenticationHandler<WeChatAuthenticationOptions>
    {
        ...
        public WeChatAccountAuthenticationHandler(HttpClient httpClient, ILogger<WeChatAccountAuthenticationHandler> logger,
            WeChatAuthenticationOptions options) : base(options, logger)
        {
        ...
        {
            _logger.LogInformation("InvokeReturnPath");
        ...
        {
            _logger.LogInformation("AuthenticateCore");
